...
sudo apt-get install -y r-cran-car r-cran-rcurl r-cran-rcpp r-cran-reshape2 r-cran-ggplot2 r-cran-randomforest r-cran-devtools r-cran-glmnet r-cran-lubridate
